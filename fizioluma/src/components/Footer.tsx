...
export function Footer() {
  ...
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-500 ">
              Kakršna koli vprašanja? Pišite nam na email ali me pokličite. Z
...
const Backlink = () => {
  return (
    ...
    >
      <img src="public/img/" alt="fizio_luma" />
